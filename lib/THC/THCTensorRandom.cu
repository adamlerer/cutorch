...
{
  THCudaCheck(THCudaMalloc((void**)&gen->gen_states, MAX_NUM_BLOCKS * sizeof(curandStateMtgp32)));
  THCudaCheck(THCudaMalloc((void**)&gen->kernel_params, sizeof(mtgp32_kernel_params)));
}
