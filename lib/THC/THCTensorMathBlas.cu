...
void THCudaTensor_baddbmm(THCState *state, THCudaTensor *result, float beta, THCudaTensor *t,
  ...
  THCudaCheck(THCudaMalloc((void**)&d_matrices1, matrices_size));
  THCudaCheck(THCudaMalloc((void**)&d_matrices2, matrices_size));
  THCudaCheck(THCudaMalloc((void**)&d_result_matrices, matrices_size));
